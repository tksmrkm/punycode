...
class PunycodeTest extends \PHPUnit_Framework_TestCase {
     ...
     */
    public function testEncodeUrl($decoded, $encoded)
    {
        $this->construct();
        $decoded_url = 'http://' . $decoded . '/someactions.html';
        $encoded_url = 'http://' . $encoded . '/someactions.html';
        $result = $this->puny->encodeUrl($decoded_url);
        $this->assertEquals($encoded_url, $result);
    }
    /**
     ...
     * @dataProvider domainNamesProvider
     */
    public function testDecodeUrl($decoded, $encoded)
    {
        $this->construct();
        $decoded_url = 'http://' . $decoded . '/someactions.html';
        $encoded_url = 'http://' . $encoded . '/someactions.html';
        $result = $this->puny->decodeUrl($encoded_url);
        $this->assertEquals($decoded_url, $result);
    }
    /**
